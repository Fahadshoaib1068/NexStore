...
public class UserRepository {
    ...
    public User findByUsername(String username) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                if (user == null) {
                    user = new User(
                            rs.getInt("userid"),          // ← fixed
                            rs.getString("username"),
                            rs.getString("email"),
                            rs.getString("passwordhash"), // ← fixed
                            rs.getInt("customerid"),      // ← fixed
                            rs.getString("created"),      // ← fixed
                            null
                    );
                }
                roles.add(rs.getString("rolename"));      // ← fixed
            }
    ...
    public Integer getRoleIdByName(String roleName) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) return rs.getInt("roleid"); // ← fixed
